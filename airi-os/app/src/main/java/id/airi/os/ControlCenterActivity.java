...
public class ControlCenterActivity extends Activity {
    ...
    private void build(){LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setPadding(dp(18),dp(26),dp(18),dp(26));root.setBackgroundColor(Color.rgb(218,235,247));
        ...
        GridLayout top=new GridLayout(this);top.setColumnCount(2);add(top,"✈  Connectivity","Wi‑Fi • Bluetooth • Network",()->open(Settings.Panel.ACTION_INTERNET_CONNECTIVITY));add(top,"▶  Media","Volume & playback controls",()->{});add(top,"☾  Focus","Do Not Disturb settings",()->open("android.settings.ZEN_MODE_SETTINGS"));add(top,"↻  Rotation","Display settings",()->open(Settings.ACTION_DISPLAY_SETTINGS));root.addView(top);
