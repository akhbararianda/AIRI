...
VersionInfoDescription=AIRI Download Manager - Large File Stability + License Cloud - Developed by AIRI Technology, Founder Akhbar Arianda
...
OutputBaseFilename=AIRI-Download-Manager-Setup-v2.7.1
OutputDir=Output
