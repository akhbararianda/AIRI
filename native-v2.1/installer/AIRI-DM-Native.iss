...
VersionInfoDescription=AIRI Download Manager - Stable UI + Persistent Resume + Advanced Browser Integration 3.6 + Universal Media Capture + License Cloud - Developed by AIRI Technology, Founder Akhbar Arianda
