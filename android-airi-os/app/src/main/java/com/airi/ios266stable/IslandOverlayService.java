...
public class IslandOverlayService extends Service {
    ...
    @Override public void onCreate(){super.onCreate();createChannel();startForeground(2667,notification());if(Build.VERSION.SDK_INT>=23&&!Settings.canDrawOverlays(this)){stopSelf();return;}showIsland();}
